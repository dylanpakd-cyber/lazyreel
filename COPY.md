...
- **H1:** `An AI agent that ==*doomscrolls*== for you.`
...
- Compatibility line (mono): `Works with Claude Code & Codex`
...
- Intro: `Paste this into Claude Code or Codex. Your agent installs the LazyReel skills, connects the MCP, and is ready to make a video on the next message.`
